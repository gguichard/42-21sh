...
#    Updated: 2019/01/09 10:18:04 by gguichar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		=	main.c env.c vars.c shell_vars.c prompt.c \
			input/term.c input/input.c input/history.c input/cmdline.c \
			input/esc_sequence.c input/input_hooks.c input/history_hooks.c \
